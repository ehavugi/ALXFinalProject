...
# response = requests.post('http://127.0.0.1:5000/train', json={'input': {'x':[6,5],"y":[2,5],},"output":{"VL":[12,55]},})
# response = requests.get('http://127.0.0.1:5000/train', json={'input': {"modelReference":"-2803657691561295276"},})
response = requests.get('http://127.0.0.1:5000/train', json={'input': {'x':[13,35,23],"y":[6,23,35],"modelReference":"1157746954101703716"}})
